...
from pydbsp1.lazy_zset import LazyZSet, LazyZSetAddition
from pydbsp1.lazy_zset.functions.bilinear import join
from pydbsp1.stream import (
    BinaryOperator,
    Lift2,
    Stream,
    StreamAddition,
...
from pydbsp1.zset.functions.bilinear import JoinCmp, PostJoinProjection
