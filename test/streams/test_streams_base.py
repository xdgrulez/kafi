...
class TestStreamsBase(TestKafkaBase):
    ...
    def go(self, built_tn, source_str_batch_size_int_dict, steps_int, checkpoint_storage=None, checkpoint_topic_str=None, recreate_boolean=True, **kwargs):
        ...
        #
        produce_thread = threading.Thread(target=self.produce, args=(source_str_topic_dict_dict, source_str_batch_size_int_dict, steps_int))
        #
        self.stop_fun = Streams.start_streams(built_tn, checkpoint_storage, checkpoint_topic_str, **kwargs)
        #
