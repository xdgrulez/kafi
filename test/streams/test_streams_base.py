...
from kafi.streams.streams import streams_thread, get_source_str_topic_dict_dict, get_sink_str_topic_dict_dict

#

class TestStreamsBase(TestKafkaBase):
    def process(self, built_tn, checkpoint_storage, checkpoint_topic, **kwargs):
        self.stop_function = streams_thread(built_tn, checkpoint_storage, checkpoint_topic, **kwargs)
