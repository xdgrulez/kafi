...
from old_pydbsp.lazy_zset import LazyZSet, LazyZSetAddition
from old_pydbsp.lazy_zset.functions.bilinear import join
from old_pydbsp.stream import (
    BinaryOperator,
    Lift2,
    Stream,
    StreamAddition,
...
from old_pydbsp.zset.functions.bilinear import JoinCmp, PostJoinProjection
