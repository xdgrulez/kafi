...
class FSConsumer(StorageConsumer):
    ...
    def offsets(self):
        all_topic_str_partition_int_offset_int_dict_dict = self.storage_obj.admin.group_offsets(self.group_str)[self.group_str]
        #
        topic_str_partition_int_offset_int_dict_dict = {topic_str: partition_int_offset_int_dict for topic_str, partition_int_offset_int_dict in all_topic_str_partition_int_offset_int_dict_dict if topic_str in self.topic_str_list}
        #
