...
[*Kafi Streams*](docs/streams.ipynb) (formerly known as [*Kafi*](docs/kafi.ipynb)[^1]) is a Python library for Kafka stream processing build by the co-author of "Streaming Databases" (with Hubert Dulay) for O'Reilly.
